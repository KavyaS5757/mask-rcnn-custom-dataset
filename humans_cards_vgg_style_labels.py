...
dataset_train.load_custom("C:/Users/kavya/Downloads/humans and cards/dataset2/","train") 
dataset_train.prepare()
print('Train: %d' % len(dataset_train.image_ids))

dataset_val = CustomDataset()
dataset_val.load_custom("C:/Users/kavya/Downloads/humans and cards/dataset2/", "val")
dataset_val.prepare()
...
# load model weights
model.load_weights('C:/logdir/train/mask_rcnn_marble_cfg_0001.h5', by_name=True)
...
marbles_img = skimage.io.imread("C:/Users/kavya/Downloads/humans and cards/dataset2/val/images.jpg")
...
detect_and_color_splash(model, image_path="C:/Users/kavya/Downloads/humans and cards/dataset2/val/images.jpg")

def evaluate1_model(model, dataset_val, cfg):
    ...
    for image_id in dataset_val.image_ids:
        image, image_meta, gt_class_ids, gt_bbox, gt_mask = load_image_gt(dataset_val, cfg, image_id, use_mini_mask=False)
        # convert pixel values (e.g. center)
        scaled_image = mold_image(image, cfg)
        # convert image into one sample
        sample = expand_dims(scaled_image, 0)
        ...
        if set(pred_class_ids) == set(gt_class_ids):
...
accuracy = evaluate1_model(model, dataset_val, cfg)
